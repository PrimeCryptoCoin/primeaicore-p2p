...
var Networks = primeaicore.Networks;
 ...
 * using the standard primeaicoin protocol. A Peer instance represents one connection
 * on the primeaicoin network. To create a new peer connection provide the host and port
