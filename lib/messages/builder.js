...
function builder(options) {
  ...
  if (!options.network) {
    options.network = primeaicore.Networks.defaultNetwork;
  }

  options.Block = options.Block || primeaicore.Block;
  options.BlockHeader = options.BlockHeader || primeaicore.BlockHeader;
  options.Transaction = options.Transaction || primeaicore.Transaction;
  options.MerkleBlock = options.MerkleBlock || primeaicore.MerkleBlock;
  options.protocolVersion = options.protocolVersion || 70025;
