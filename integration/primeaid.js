...
var Random = primeaicore.crypto.Random;
var BN = primeaicore.crypto.BN;
...
// These tests require a running primeaid instance
describe('Integration with ' + network.name + ' primeaid', function() {
