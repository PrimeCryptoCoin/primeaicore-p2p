'use strict';
/* eslint-env es6 */
let Pool = require('primeaicore-p2p').Pool;
let BloomFilter = require('primeaicore-p2p').BloomFilter;
let NetworksData = require('primeaicore-lib').Networks;
let Messages = require('primeaicore-p2p').Messages;
...
// Create a filter and a primeaicoin message with the filter
...
// Create a primeaicoin message for require a merkleblock
